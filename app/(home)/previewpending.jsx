...
const PreviewBoarding = () => {
  const { id, ratings } = useLocalSearchParams();
  ...
  const { deleteBoarding, toggleAvailability } = useAdmin();
                    ...
                    <View>
                      ...
                      >
                        ...
                        <View style={{ paddingEnd: 20, width: "auto" }}>
                          <Stars ratingArray={ratingsArray} />
                        </View>
                      </View>
                        ...
                        <View style={styles.contactInfo}>
                          ...
                          <View style={styles.contactIcons}>
                            <Feather
                              ...
                              onPress={() =>
                                openURL(
                                  `tel:+${boardingDetails.profiles?.contact}`
                                )
                              }
                            />
                            <MaterialIcons
                              ...
                              onPress={() =>
                                openURL(
                                  `sms:+${boardingDetails.profiles?.contact}`
                                )
                              }
                            />
                          </View>
...
export default PreviewBoarding;
